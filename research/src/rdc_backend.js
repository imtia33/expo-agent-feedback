...
function inspectHooksOfFiberImpl(fiber, currentDispatcher) {
  ...
  try {
    ...
    if (11 === fiber.tag) {
      ...
      context = props;
      var ref = fiber.ref,
        previousDispatcher = currentDispatcher.H;
      currentDispatcher.H = DispatcherProxy;
      try {
        var ancestorStackError = Error();
...
function getElementKey(element, index) {
  return "object" === _typeof(element) && null !== element && null != element.key ? element.key === REACT_OPTIMISTIC_KEY ? index.toString(36) : escape("" + element.key) : index.toString(36);
}
...
;// CONCATENATED MODULE: ../shared/reportGlobalError.js
/* provided dependency */ var process = __webpack_require__(169);
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
/* harmony default export */ const shared_reportGlobalError = (reportGlobalError);
...
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == events_typeof(i) ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != events_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != events_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
/* provided dependency */ var utils_process = __webpack_require__(169);
...
function setupHighlighter(bridge, agent) {
  ...
  function highlightHostInstance(_ref2) {
    var displayName = _ref2.displayName,
      ...
      id = _ref2.id,
      openBuiltinElementsPanel = _ref2.openBuiltinElementsPanel,
  ...
  function highlightHostInstances(_ref3) {
    var displayName = _ref3.displayName,
      hideAfterTimeout = _ref3.hideAfterTimeout,
...
var Bridge = /*#__PURE__*/function (_EventEmitter) {
      ...
      try {
        if (_this._messageQueue.length) {
          for (var i = 0; i < _this._messageQueue.length; i++) {
            var _this$_messageQueue$i = _this._messageQueue[i],
              event = _this$_messageQueue$i.event,
              payload = _this$_messageQueue$i.payload;
  ...
  return bridge_createClass(Bridge, [{
    ...
    value: function addListener(event, listener) {
      ...
      _get(_getPrototypeOf(Bridge.prototype), "addListener", this).call(this, event, listener);
    }
  }, {
    key: "emit",
    value: function emit(event) {
      ...
      (_get2 = _get(_getPrototypeOf(Bridge.prototype), "emit", this)).call.apply(_get2, [this, event].concat(args));
    }
  }, {
    key: "send",
  ...
  function Agent(bridge) {
    ...
    agent_defineProperty(_this, "overrideSuspenseMilestone", function (_ref14) {
      var rendererID = _ref14.rendererID,
        suspendedSet = _ref14.suspendedSet;
      var renderer = _this._rendererInterfaces[rendererID];
...
var ReactSymbols_REACT_OPTIMISTIC_KEY = Symbol.for('react.optimistic_key');
;// CONCATENATED MODULE: ../react-devtools-shared/src/config/DevToolsFeatureFlags.core-oss.js
var enableActivitySlices = (/* unused pure expression or super */ null && (false));
...
;// CONCATENATED MODULE: ../react-devtools-shared/src/backend/DevToolsNativeHost.js
function DevToolsNativeHost_typeof(o) { "@babel/helpers - typeof"; return DevToolsNativeHost_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, DevToolsNativeHost_typeof(o); }
...
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = DevToolsFiberChangeDetection_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }
function DevToolsFiberChangeDetection_toConsumableArray(arr) { return DevToolsFiberChangeDetection_arrayWithoutHoles(arr) || DevToolsFiberChangeDetection_iterableToArray(arr) || DevToolsFiberChangeDetection_unsupportedIterableToArray(arr) || DevToolsFiberChangeDetection_nonIterableSpread(); }
function DevToolsFiberChangeDetection_nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function DevToolsFiberChangeDetection_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return DevToolsFiberChangeDetection_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return DevToolsFiberChangeDetection_arrayLikeToArray(o, minLen); }
function DevToolsFiberChangeDetection_iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
function DevToolsFiberChangeDetection_arrayWithoutHoles(arr) { if (Array.isArray(arr)) return DevToolsFiberChangeDetection_arrayLikeToArray(arr); }
function DevToolsFiberChangeDetection_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
...
;// CONCATENATED MODULE: ../react-devtools-shared/src/backend/fiber/shared/DevToolsFiberInternalReactConstants.js
function DevToolsFiberInternalReactConstants_typeof(o) { "@babel/helpers - typeof"; return DevToolsFiberInternalReactConstants_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, DevToolsFiberInternalReactConstants_typeof(o); }
...
;// CONCATENATED MODULE: ../react-devtools-shared/src/backend/fiber/shared/DevToolsFiberSuspense.js
...
;// CONCATENATED MODULE: ../react-devtools-shared/src/backend/fiber/shared/DevToolsFiberTypes.js
var FIBER_INSTANCE = 0;
var VIRTUAL_INSTANCE = 1;
var FILTERED_FIBER_INSTANCE = 2;
;// CONCATENATED MODULE: ../react-devtools-shared/src/backend/shared/DevToolsReactDispatcher.js
...
function renderer_slicedToArray(arr, i) { return renderer_arrayWithHoles(arr) || renderer_iterableToArrayLimit(arr, i) || fiber_renderer_unsupportedIterableToArray(arr, i) || renderer_nonIterableRest(); }
...
function renderer_createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = fiber_renderer_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }
...
function renderer_attach(hook, rendererID, renderer, global, shouldStartProfilingNow, profilingSettings, componentFiltersOrComponentFiltersPromise) {
  ...
  function updateComponentFilters(componentFilters) {
    ...
    if (typeof scheduleUpdate === 'function') {
      if (previousForcedFallbacks !== null) {
        var _iterator4 = renderer_createForOfIteratorHelper(previousForcedFallbacks),
          _step4;
        try {
      ...
      if (previousForcedErrors !== null && typeof setErrorHandler === 'function') {
        ...
        var _iterator5 = renderer_createForOfIteratorHelper(previousForcedErrors),
          _step5;
        try {
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
            var _step5$value = renderer_slicedToArray(_step5.value, 2),
              _fiber = _step5$value[0],
              shouldError = _step5$value[1];
  ...
  function shouldFilterVirtual(data, secondaryEnv) {
    ...
    if (hideElementsWithDisplayNames.size > 0) {
      ...
      if (displayName != null) {
        var _iterator6 = renderer_createForOfIteratorHelper(hideElementsWithDisplayNames),
          _step6;
        try {
  ...
  function shouldFilterFiber(fiber) {
    ...
    if (hideElementsWithDisplayNames.size > 0) {
      ...
      if (displayName != null) {
        var _iterator7 = renderer_createForOfIteratorHelper(hideElementsWithDisplayNames),
          _step7;
        try {
  ...
  function addUnfilteredChildrenIDs(parentInstance, nextChildren) {
    ...
    while (child !== null) {
      if (child.kind === FILTERED_FIBER_INSTANCE) {
        ...
        if (isHiddenOffscreen(fiber) && !isActivityHiddenOffscreen(fiber)) {} else {
  ...
  function reconnectChildrenRecursively(parentInstance) {
    for (var child = parentInstance.firstChild; child !== null; child = child.nextSibling) {
      ...
      if ((child.kind === FIBER_INSTANCE || child.kind === FILTERED_FIBER_INSTANCE) && isHiddenOffscreen(child.data) && !isActivityHiddenOffscreen(child.data)) {} else {
  ...
  function getSuspendedByOfSuspenseNode(suspenseNode, filterByChildInstance) {
    ...
    suspenseNode.suspendedBy.forEach(function (set, ioInfo) {
      ...
      if (filterByChildInstance === null) {
        ...
        var _iterator8 = renderer_createForOfIteratorHelper(set.values()),
          _step8;
        try {
...
function attachRenderer(hook, id, renderer, global, shouldStartProfilingNow, profilingSettings, componentFiltersOrComponentFiltersPromise) {
  ...
  if (rendererInterface == null) {
    if (typeof renderer.getCurrentComponentInfo === 'function') {
      ...
      rendererInterface = renderer_attach(hook, id, renderer, global, shouldStartProfilingNow, profilingSettings, componentFiltersOrComponentFiltersPromise);
...
function installHook(target, componentFiltersOrComponentFiltersPromise, maybeSettingsOrSettingsPromise) {
  var shouldStartProfilingNow = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  var profilingSettings = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : defaultProfilingSettings;
  ...
  function inject(renderer) {
    ...
    var rendererInterface = attachRenderer(hook, id, renderer, target, isProfiling, profilingSettings, componentFiltersOrComponentFiltersPromise);
    if (rendererInterface != null) {
...
function backend_initialize(maybeSettingsOrSettingsPromise) {
  ...
  var maybeComponentFiltersOrComponentFiltersPromise = arguments.length > 3 ? arguments[3] : undefined;
